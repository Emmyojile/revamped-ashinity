...
const teamList: TeamProps[] = [
  {
    imageUrl: "https://ashinity.com/_next/static/media/ceo_profile.7305b8fa.png",
    name: "Meshach Ishaya",
  ...
  return (
    ...
    >
      <h2 className="text-3xl md:text-4xl font-bold">
        <span className="bg-gradient-to-b from-primary/60 to-primary text-green-70 bg-clip-text">
          Meet Our{" "}
        </span>
        Team
      </h2>
          ...
          ({ imageUrl, name, position, socialNetworks }: TeamProps) => (
            ...
            >
              <CardHeader className="mt-8 flex justify-center items-center pb-2">
                ...
                <CardDescription className="text-green-70">
                  {position}
                </CardDescription>
              </CardHeader>
